        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Professional Installation Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('professional-install.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
