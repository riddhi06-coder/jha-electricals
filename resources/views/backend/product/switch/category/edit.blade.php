        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Edit Switch Category Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                    <a href="{{ route('switch-product-category.index') }}">Home</a>
                    </li>
                    <li class="breadcrumb-item active">Edit Switch Category</li>
                </ol>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('switch-product-category.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT') 
                                    ...
                                    <!-- Image Preview -->
                                    <div class="col-12">
                                        <img id="imagePreview" src="{{ asset('/uploads/products/' . $details->image) }}" alt="Image Preview" class="img-thumbnail {{ $details->image ? '' : 'd-none' }}" width="100" height="100">
                                    </div>

                                    <!-- Form Actions -->
                                    <div class="col-12 text-end">
                                        <a href="{{ route('switch-product-category.index') }}" class="btn btn-danger px-4">Cancel</a>
