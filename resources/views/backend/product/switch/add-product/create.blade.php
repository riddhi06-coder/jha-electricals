            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Switch</li>
                </ol>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('switch-add-products.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
