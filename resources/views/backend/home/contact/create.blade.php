                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-contact.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                      ...
                                      <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="banner_heading" type="text" name="banner_heading" placeholder="Enter Heading"  required>
