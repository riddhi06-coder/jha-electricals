        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Testimonial Details Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('home-testimonails.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="name" type="text" name="name" placeholder="Enter Reviewer's Name" required>
                                    ...
                                    <div class="col-xxl-4 col-sm-12">
                                        ...
                                        <textarea class="form-control" id="summernote" name="message" placeholder="Enter Message" required></textarea>
