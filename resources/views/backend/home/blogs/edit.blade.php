                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate 
                                    action="{{ route('home-blogs.update', $blogs->id) }}" method="POST" 
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="blog_author" type="text" name="blog_author" 
                                            placeholder="Enter Blog Author" value="{{ old('blog_author', $blogs->blog_author) }}" required>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="blog_date" type="date" name="blog_date" 
                                            value="{{ old('blog_date', $blogs->blog_date) }}" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div>
                                            @if($blogs->image)
                                                <img id="imagePreview" src="{{ asset('uploads/home/blogs/' . $blogs->image) }}" 
