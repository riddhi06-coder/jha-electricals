                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
								...
								<a href="{{ route('home-footer.create') }}" class="btn btn-primary px-5 radius-30">+ Add Company Details</a>
							</div>
                      ...
                      <table class="display" id="basic-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $detail->time }}</td>
                                <td>
                                    <a href="{{ route('home-footer.edit', $detail->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                    <form action="{{ route('home-footer.destroy', $detail->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
