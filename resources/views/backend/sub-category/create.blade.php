                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('sub-category.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <!-- Sub Category Name -->
                                    <div class="col-6">
                                        <label class="form-label" for="category_name">Sub Category Name <span class="txt-danger">*</span></label>
                                        <input type="text" class="form-control @error('sub_category_name') is-invalid @enderror" id="sub_category_name" name="sub_category_name" value="{{ old('sub_category_name') }}" placeholder="Enter Sub Category Name" required>
