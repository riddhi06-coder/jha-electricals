                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('who-we-are.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT') 
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="banner_image" type="file" name="banner_image" accept=".jpg, .jpeg, .png, .webp" onchange="previewImage(this, '#banner_image_preview')">
                                        <div class="invalid-feedback">Please upload a Banner Image.</div>
                                        <small class="text-secondary"><b>Note: The file size should be less than 2MB.</b></small>
                                        <br>
                                        <small class="text-secondary"><b>Note: Only files in .jpg, .jpeg, .png, .webp format can be uploaded.</b></small>
                                        <div id="banner_image_preview" class="mt-2">
                                            @if($details->banner_image)
                                                <img src="{{ asset('uploads/about/' . $details->banner_image) }}" alt="Banner Image" width="100">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="image" type="file" name="image" accept=".jpg, .jpeg, .png, .webp" onchange="previewImage(this, '#image_preview')">
                                        ...
                                        <div id="image_preview" class="mt-2">
                                            @if($details->image)
                                                <img src="{{ asset('uploads/about/' . $details->image) }}" alt="Image" width="100">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-4 col-sm-6">
                                        ...
                                        <input class="form-control" id="icon" type="file" name="icon" accept=".jpg, .jpeg, .png, .webp" onchange="previewIcon(this)">
                                        ...
                                        <div id="icon_preview" class="mt-2">
                                            @if($details->icon)
                                                <img src="{{ asset('uploads/about/' . $details->icon) }}" alt="Icon" width="100">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-4 col-sm-12">
                                        ...
                                        <textarea class="form-control" id="short_description" name="short_description" placeholder="Enter Short Description" rows="3" required>{{ old('short_description', $details->short_description) }}</textarea>
