        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-6">
                  <h4>Add Commercial Part C Form</h4>
                </div>
                <div class="col-6">
                <ol class="breadcrumb">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate 
                                    action="{{ route('commercial-light-partC.update', $details->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div id="image_preview" class="mt-2">
                                            @if ($details->image)
                                                <img src="{{ asset('uploads/application/' . $details->image) }}" alt="Uploaded Image" width="100">
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-12 text-end">
                                        <a href="{{ route('commercial-light-partC.index') }}" class="btn btn-danger px-4">Cancel</a>
