                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">    
                            ...
                            <div class="tab-content" id="wizard-tabContent">
                                ...
                                <form class="row g-3 needs-validation custom-input" novalidate action="{{ route('blog-types.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="blog_heading" name="blog_heading" placeholder="Enter Blog Heading" required>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <textarea class="form-control" id="short_description" name="short_description" placeholder="Enter Short Description" rows="1" required></textarea>
