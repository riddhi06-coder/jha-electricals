                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('blog-types.create') }}" class="btn btn-primary px-5 radius-30">+ Add Blogs</a>
                    </div>
                        ...
                        <tbody>
                             @foreach($details as $key => $blog)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('blog-types.edit', $blog->id) }}" class="btn btn-sm btn-primary">Edit</a>
