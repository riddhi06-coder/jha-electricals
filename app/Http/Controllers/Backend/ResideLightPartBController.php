...
class ResideLightPartBController extends Controller
{

    public function index()
    {
        $details = ResideLightPartB::orderBy('id', 'desc')->whereNull('deleted_by')->get();
        return view('backend.application.residential.partB.index', compact('details'));
    }

    public function create(Request $request)
    { 
        return view('backend.application.residential.partB.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('reside-light-partB.index')->with('message', 'Details added successfully.');
    }

    public function edit($id)
    {
        $details = ResideLightPartB::findOrFail($id);
        ...
        return view('backend.application.residential.partB.edit', compact('details', 'calculation_images', 'calculation_titles', 'calculation_descriptions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('reside-light-partB.index')->with('message', 'Details updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = ResideLightPartB::findOrFail($id);
            $industries->update($data);

            return redirect()->route('reside-light-partB.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
