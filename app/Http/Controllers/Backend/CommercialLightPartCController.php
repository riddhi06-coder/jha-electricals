...
class CommercialLightPartCController extends Controller
{

    public function index()
    {
        $details = CommercialLightPartC::orderBy('id', 'desc')->whereNull('deleted_by')->get();
        return view('backend.application.commercial.partC.index', compact('details'));
    }

    public function create(Request $request)
    { 
        return view('backend.application.commercial.partC.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('commercial-light-partC.index')->with('message', 'Details added successfully.');
    }

    public function edit($id)
    {
        $details = CommercialLightPartC::findOrFail($id);
        return view('backend.application.commercial.partC.edit', compact('details'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('commercial-light-partC.index')->with('message', 'Details updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = CommercialLightPartC::findOrFail($id);
            $industries->update($data);

            return redirect()->route('commercial-light-partC.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
