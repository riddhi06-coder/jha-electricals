...
class PreWiringController extends Controller
{

    public function index()
    {
        $details = PreWiring::orderBy('id', 'desc')->whereNull('deleted_by')->get();
        return view('backend.services.consult.index', compact('details'));
    }

    public function create(Request $request)
    { 
        return view('backend.services.consult.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pre-wiring.index')->with('message', 'Details added successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.services.consult.edit', compact('details', 'calculation_images', 'calculation_titles', 'calculation_descriptions'));
    }
