...
class PostInstallController extends Controller
{
    ...
    {
        $details = PostInstallation::orderBy('id', 'desc')->whereNull('deleted_by')->get();
        return view('backend.services.training.index', compact('details'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('post-install.index')->with('message', 'Details added successfully.');
    }

    public function edit($id)
    {
        $details = PostInstallation::findOrFail($id);
        ...
        return view('backend.services.training.edit', compact('details', 'calculation_images', 'calculation_titles', 'calculation_descriptions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('post-install.index')->with('message', 'Details updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = PostInstallation::findOrFail($id);
            $industries->update($data);

            return redirect()->route('post-install.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
