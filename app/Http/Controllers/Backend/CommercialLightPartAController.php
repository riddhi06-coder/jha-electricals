...
class CommercialLightPartAController extends Controller
{

    public function index()
    {
        $details = CommercialLightPartA::orderBy('id', 'desc')->whereNull('deleted_by')->get();
        return view('backend.application.commercial.partA.index', compact('details'));
    }

    public function create(Request $request)
    { 
        return view('backend.application.commercial.partA.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('commercial-light-partA.index')->with('message', 'Details added successfully.');
    }

    public function edit($id)
    {
        $details = CommercialLightPartA::findOrFail($id);
        ...
        return view('backend.application.commercial.partA.edit', compact('details', 'calculation_images', 'calculation_titles', 'calculation_descriptions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('commercial-light-partA.index')->with('message', 'Details updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = CommercialLightPartA::findOrFail($id);
            $industries->update($data);

            return redirect()->route('commercial-light-partA.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
