...
class ProductDetailController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('product-detail.index')->with('message', 'Product details updated successfully!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return redirect()->route('product-detail.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
