...
use App\Models\SwitchDetail;
use Carbon\Carbon;


class SwitchDetailController extends Controller
{

    public function index()
    {
        $products = SwitchDetail::with('product') 
            ->whereNull('deleted_by')
            ->get(); 
    
        return view('backend.product.switch.product-details.index', compact('products'));
    }
    ...
    { 
        ...
        $products = Switches::whereNull('deleted_by')->get();
        ...
        return view('backend.product.switch.product-details.create', compact('categories', 'groupedProducts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('switch-product-detail.index')->with('message', 'Switch details saved successfully!');
    }
    ...
    public function edit($id)
    {
        ...
        $details = SwitchDetail::findOrFail($id);
        ...
        return view('backend.product.switch.product-details.edit', compact('details', 'categories', 'groupedProducts', 'products'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $productDetail = SwitchDetail::findOrFail($id);
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = SwitchDetail::findOrFail($id);
            $industries->update($data);

            return redirect()->route('switch-product-detail.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
