...
class PostInstallPartCController extends Controller
{

    public function index()
    {
        $details = PostInstallPartC::orderBy('id', 'desc')->whereNull('deleted_by')->get();
        return view('backend.services.training.partC.index', compact('details'));
    }

    public function create(Request $request)
    { 
        return view('backend.services.training.partC.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('post-install-partC.index')->with('message', 'Details added successfully.');
    }

    public function edit($id)
    {
        $details = PostInstallPartC::findOrFail($id);
        ...
        return view('backend.services.training.partC.edit', compact('details', 'calculation_images', 'calculation_titles', 'calculation_descriptions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('post-install-partC.index')->with('message', 'Details updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = PostInstallPartC::findOrFail($id);
            $industries->update($data);

            return redirect()->route('post-install-partC.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
