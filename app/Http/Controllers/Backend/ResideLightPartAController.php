...
class ResideLightPartAController extends Controller
{

    public function index()
    {
        $details = ResideLightPartA::orderBy('id', 'desc')->whereNull('deleted_by')->get();
        return view('backend.application.residential.partA.index', compact('details'));
    }

    public function create(Request $request)
    { 
        return view('backend.application.residential.partA.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('reside-light-partA.index')->with('message', 'Details added successfully.');
    }

    public function edit($id)
    {
        $details = ResideLightPartA::findOrFail($id);
        ...
        return view('backend.application.residential.partA.edit', compact('details', 'calculation_images', 'calculation_titles', 'calculation_descriptions'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('reside-light-partA.index')->with('message', 'Details updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = ResideLightPartA::findOrFail($id);
            $industries->update($data);

            return redirect()->route('reside-light-partA.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
