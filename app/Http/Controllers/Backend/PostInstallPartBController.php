...
class PostInstallPartBController extends Controller
{

    public function index()
    {
        $details = PostInstallPartB::orderBy('id', 'desc')->whereNull('deleted_by')->get();
        return view('backend.services.training.partB.index', compact('details'));
    }

    public function create(Request $request)
    { 
        return view('backend.services.training.partB.create');
    }
    ...
    {
        $details = PostInstallPartB::findOrFail($id);
        ...
        return view('backend.services.training.partB.edit', compact('details', 'calculation_images', 'calculation_titles', 'calculation_descriptions'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = PostInstallPartB::findOrFail($id);
            $industries->update($data);

            return redirect()->route('post-install-partB.index')->with('message', 'Details deleted successfully!');
        } catch (Exception $ex) {
