...
class AccesoriesCategoryController extends Controller
{
    ...
    {
        $details = AccessoriesCategory::findOrFail($id);
        return view('backend.product.accessories.category.edit', compact('details'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $category = AccessoriesCategory::findOrFail($id);
        $slug = Str::slug($request->category_name, '-');
        ...
        return redirect()->route('accessories-product-category.index')->with('message', 'Accessories category updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            $industries = AccessoriesCategory::findOrFail($id);
            $industries->update($data);

            return redirect()->route('accessories-product-category.index')->with('message', 'Category deleted successfully!');
        } catch (Exception $ex) {
